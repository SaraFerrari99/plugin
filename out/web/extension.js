        ...
        panel.webview.onDidReceiveMessage(message => {
            ...
            switch (message.command) {
                ...
                case 'apriNotebook':
                    ...
                    const notebookPath = path.join(path.dirname(__dirname), 'notebooks', 'ciao.ipynb');
                    /*
                    ...
                    // Aprire il file del notebook Jupyter con solo l'output (preview: true)
                    vscode.workspace.openTextDocument(vscode.Uri.file(notebookPath)).then(document => {
